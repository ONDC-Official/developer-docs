        ...
        properties: {
          ...
          items: {
            ...
            items: {
              ...
              properties: {
                id: { type: "string", pattern: "^(?!s*$).+" },
                parent_item_id: { type: "string", pattern: "^(?!s*$).+" },
                descriptor: {
                  type: "object",
                  properties: {
                ...
                price: {
                  ...
                  properties: {
                    ...
                    offered_value: { type: "string", pattern: "^d*.?d*$" },
                    maximum_value: { type: "string", pattern: "^d*.?d*$" },
                  },
